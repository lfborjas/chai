...
module.exports = function (chai, _) {
   ...
   * On top of the strict equality, it asserts that the values are
   * not observably distinguishable (that is, NaN ought to equal NaN and -0 shouldn't equal +0)
